...
| ---- | -- | ----------------------------------------------------- | ---------- | -------------------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [x ]  | 1  | Maximum Average Subarray I                            | Easy       | Fixed Sliding Window             | https://leetcode.com/problems/maximum-average-subarray-i/                              | Maintain window sum of size `k` and update max average       |
